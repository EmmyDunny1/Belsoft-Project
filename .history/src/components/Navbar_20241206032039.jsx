...
const Navbar = () => {
  return (
    <nav className='border-[0.5px] border-[#75687e] top-0 left-0 right-0 fixed w-[10rem] h-[7.81rem] '> 
<div className='flex justify-between gap-[18rem]  mx-[5.19rem]'>
...
{/* Menu */}
<div className='my-auto  flex items-end space-x-[3.8rem] justify-between'>
