...
<div className=' mx-[5.19rem] flex justify-between items-center   max-w-[97.7'>
...
{/* Menu */}
<div className='my-auto  font-medium flex  space-x-[3.8rem]'>
<div className=' items-end space-x-[1.88rem] text-[1.5rem] my-auto ml-[15rem]'> 
