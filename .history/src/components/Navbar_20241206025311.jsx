...
{/* Menu */}
<div className='my-auto   items-end space-x-[1.88rem] justify-between'>
<div className='flex items-end space-x-[1.88rem] justify-between'> <a href="#home" className=''>Home</a>
