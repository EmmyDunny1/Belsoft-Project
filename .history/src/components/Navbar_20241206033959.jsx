...
<div className=' items-end space-x-[1.88rem] my-auto justify-between'> <a href="#home" className=''>Home</a>
    <a href="#about" className=''>About Us </a>
    <a href="#gallery" className=''>Gallery</a>
    <a href="#contact" className=''>Contact Us</a> </div>
    <button className='ml-[3.8rem] text-[1.75rem] font-medium h-[3.7rem] w-[12.28rem] text-purple-800 bg-white border rounded-md'> Register </button>
