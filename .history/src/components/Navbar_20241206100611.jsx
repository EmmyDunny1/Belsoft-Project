...
const Navbar = () => {
  return (
    <nav className=' border-[0.5px] border-[#75687e] top-0 left-0 right-0 fixed w-full h-[7.81rem] items-center'> 
<div className='flex justify-between items-end w-full max-w-[97.7]  mx-auto'>
