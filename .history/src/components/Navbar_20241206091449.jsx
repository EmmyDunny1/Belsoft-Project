...
const Navbar = () => {
  return (
    <nav className=' border-[0.5px] border-[#75687e] top-0 left-0 right-0 fixed w-[108rem] h-[7.81rem] '> 
<div className='flex max-w-[108rem] justify-between    mx-[5.19rem]'>
...
{/* Menu */}
<div className='my-auto  flex  space-x-[3.8rem] justify-between '>
<div className=' items-end space-x-[1.88rem] text-[1.5rem] my-auto justify-between'> <a href="#home" className=''>Home</a>
